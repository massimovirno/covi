...
CREATE TABLE IF NOT EXISTS `location` (
  ...
  `nome_location`     varchar(100)  DEFAULT NULL,
  `via_location`      varchar(100)  DEFAULT NULL,
  `CAP_location`      varchar(5)    DEFAULT NULL,
  `citta_location`    varchar(20)   DEFAULT NULL,
  `email_location`    varchar(80)   DEFAULT NULL,
  `telefono_location` varchar(35)   DEFAULT NULL,
...
INSERT INTO `vino` 
(`Vinoid`,  `nome_vino`,          `produttore`,     `denominazione`,                   `paese`,  `regione`,  `descrizione`,                                                                                                                                                                                                                                                                                                                                                `vitigno`,        `annata`, `grado`, `volume`, `colore`, `noteSensoriali`,                                                                                                                                                                   `temperaturaServizio`, `prezzo`, `etichetta`) VALUES
...
(`locationID`, `nome_location`        , `via_location`,                    `CAP_location`, `citta_location`, `email_location`              , `telefono_location`) VALUES
(           1, 'Benvenuti al Sud Food', 'Piazza Tommaso De Cristoforis 6', '00159'       , 'Roma'          , 'benvenutialsudfood@gmail.com', '06 92092372'      ),
(           2, 'L''immagine Bistrot'  , 'Via Varesina, 61'               , '20156'       , 'Milano'        , 'immaginebistrot@libero.it'   , '02 39264564'      ),
(           3, 'Zi Teresa'            , 'Borgo Marinaro, 1'              , '80123'       , 'Napoli'        , 'ZiTeresa@gmail.com'          , '081 7642565'      ),
(           4, 'Al Brigantino'        , 'Via Torretta, 104'              , '90147'       , 'Palermo'       , 'AlBrigantino@alice.it'       , '091 6911778'      );
...
INSERT INTO `evento` 
(`eventoID`,  `vinoID_FK`, `locationID_FK`, `nome_evento`    , `data_evento`        , `data_chiusura`      , `posti`, `descBreve`                                                   , `descrizione`                                                                 , `prezzo`, `categoria`, `foto`      , `pubblicato`) VALUES
(         1,            1,               1, 'Cena a casa mia', '2018-09-01 22:30:00', '2018-08-15 23:59:00',      10, 'Cena leggera a casa mia con cous cous e contorni di verdure.', 'Il menu prevede un cous cous con melanzane e zucchine. Cortorno di peperoni.',       10, 'casa'     , 'foto01.jpg',            1),  
(         2,            2,               1, 'BBQ in giardino', '2018-09-03 21:00:00', '2018-09-17 23:59:00',       5, 'Brace con bistecche e salsicce'                              , 'Brace nel giardino con carni e bruschette.'                                  ,       25, 'giardino' , 'foto02.jpg',            1);
