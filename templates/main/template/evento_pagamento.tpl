        ...
        <form method="post" action="index.php">
            <fieldset><legend>&nbsp;DATI CARTA DI CREDITO&nbsp;</legend>
                ...
                <p><label for="cognome_titolare" class="left">Cognome intestatario:</label>
                   <input type="text" name="cognome_titolare" id="cognome_titolare" class="field" value="" tabindex="7" /></p>
                <p><label for="scadenza" class="left">Scadenza:</label>
                   <input type="text" name="scadenza" id="scadenza" class="field" value="" tabindex="8" /></p>
                <p><label for="ccv" class="left">CCV:</label>
                   <input type="text" name="ccv" id="ccv" class="field" value="" tabindex="9" /></p>
